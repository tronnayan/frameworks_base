...
package com.android.internal.util.narvis;
    ...
    public static void processActionWithOptions(Context context,
            ...
            if (action.equals(ActionConstants.ACTION_HOME)) {
                ...
                try {
                    ...
                    Log.e("narvisActions:", "No activity to handle assist long press action.", e);
                }
                return;
                ...
                try {
                    ...
                    Log.e("narvisActions:", "URISyntaxException: [" + action + "]");
                    return;
                }
                startActivity(context, intent);
                return;
